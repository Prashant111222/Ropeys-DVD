<%@ Page Title="" Language="C#" MasterPageFile="~/AssistantMaster.Master" AutoEventWireup="true" CodeBehind="DVDCopy.aspx.cs" Inherits="RopeysDVD.DVDCopy1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div class="card-body">
            ...
            <div class="col d-flex justify-content-center">
                <div class="col-md-4">
                    ...
                    <asp:Calendar ID="datePurchased" CssClass="form-control" runat="server"></asp:Calendar>
                </div>
            </div>
                <br />
            <div class="col d-flex justify-content-center">
                ...
                <br />
            <div class="col d-flex justify-content-center">
                <asp:Button ID="Button_Submit" CssClass="btn btn-primary" runat="server" Text="Add DVD Copy" OnClick="Button_Submit_Click" />
    ...
    <div class="card col-md-12">
        <div class="card-body">
            <asp:GridView ID="CopyGV" PageSize="5" AllowPaging="true" OnPageIndexChanging="OnPageIndexChanging" CssClass="table table-dark table-sm table-hover" runat="server" AutoGenerateColumns="false" OnRowCommand="CopyGV_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:LinkButton ID="Action_Button" runat="server" CssClass="btn btn-secondary" CommandName="View" CommandArgument='<%#Bind("CopyNumber")%>' CausesValidation="false">Select</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
