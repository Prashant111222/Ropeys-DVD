<%@ Page Title="" Language="C#" MasterPageFile="~/AssistantMaster.Master" AutoEventWireup="true" CodeBehind="Actor.aspx.cs" Inherits="RopeysDVD.Actor1" %>
        ...
        <div class="card-body">
            <div class="col d-flex justify-content-center">
                <div class="col-md-4">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="id" ControlToValidate="actorSurname" ErrorMessage="Please Enter Actor Surname!" ForeColor="Red"/>
                </div>
            </div>
                <br />
            <div class="col d-flex justify-content-center">
            ...
            <div class="col d-flex justify-content-center">
                ...
                <br />
            <div class="col d-flex justify-content-center">
                <asp:Button ID="Button_Submit" CssClass="btn btn-primary" runat="server" Text="Add Actor" OnClick="Button_Submit_Click" />
