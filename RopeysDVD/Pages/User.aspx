<%@ Page Title="RopeysDVD | Users" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="User.aspx.cs" Inherits="RopeysDVD.User1" %>
    <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
            ...
            <div class="card-body">
                <div class="col d-flex justify-content-center">
                    <div class="col-md-4">
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="id" ControlToValidate="userName"
                            ValidationGroup="required" ErrorMessage="Please Enter User Name!" ForeColor="Red" />
                    </div>
                </div>
                <div class="col d-flex justify-content-center">
                    <div class="col-md-4">
                ...
                <div class="col d-flex justify-content-center">
                    <div class="col-md-4">
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1"
                            ControlToValidate="userPassword" ValidationGroup="required"
                            ErrorMessage="Please Enter User Password!" ForeColor="Red" />
                    </div>
                </div>
                <br />
                <div class="col d-flex justify-content-center">
                ...
                <div class="col d-flex justify-content-center">
                    <asp:Button ID="Button_Submit" ValidationGroup="required" CssClass="btn btn-primary" runat="server"
                        Text="Add User" OnClick="Button_Submit_Click" />
        ...
        <div class="card col-md-12">
            <div class="card-body">
                <asp:GridView ID="UserGV" PageSize="5" AllowPaging="true" OnPageIndexChanging="OnPageIndexChanging"
                    CssClass="table table-dark table-sm table-hover" runat="server" AutoGenerateColumns="false"
                    OnRowCommand="UserGV_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:LinkButton ID="Action_Button" runat="server" CssClass="btn btn-secondary"
                                    CommandName="View" CommandArgument='<%#Bind("UserNumber")%>'
