<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="Member.aspx.cs" Inherits="RopeysDVD.Member1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div class="card-body">
            <div class="col d-flex justify-content-center">
                <div class="col-md-4">
                    ...
                    <asp:DropDownList CssClass="form-control" ID="membershipCategory" runat="server"></asp:DropDownList>
                </div>
            </div>
            <br />
            <div class="col d-flex justify-content-center">
            ...
            <div class="col d-flex justify-content-center">
                ...
                <br />
            <div class="col d-flex justify-content-center">
                <asp:Button ID="Button_Submit" CssClass="btn btn-primary" runat="server" Text="Add Member" OnClick="Button_Submit_Click" />
    ...
    <div class="card col-md-12">
        <div class="card-body">
            <asp:GridView ID="MemberGV" PageSize="5" AllowPaging="true" OnPageIndexChanging="OnPageIndexChanging" CssClass="table table-dark table-sm table-hover" runat="server" AutoGenerateColumns="false" OnRowCommand="MemberGV_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Category Number">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="ActorLastName" Text='<%#Eval("MembershipCategoryNumber") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="DOB">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="Label5" Text='<%#Eval("MemberDateOfBirth") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:LinkButton ID="Action_Button" runat="server" CssClass="btn btn-secondary" CommandName="View" CommandArgument='<%#Bind("MemberNumber")%>' CausesValidation="false">Select</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
